---
title: "type-challenges をやってみる(その 1)"
date: "2023-01-06"
slug: "try-type-challenges-1"
emoji: "👋"
...
- object の修飾子は extends に影響しない \*/}
  </div>
正直一番この中で難しく感じました。
本当はうまいこと説明したかったのですが、今の知識だとできないのでまたどこかで詳しい記事を書きます。
...
1. [Spread](https://www.typescriptlang.org/docs/handbook/variable-declarations.html#spread)
